...
var shotgunController = require('./controllers/shotgun');
var carController = require('./controllers/car');
var disputeController = require('./controllers/dispute');
...
app.get('/api/shotguns', shotgunController.list);
app.get('/api/cars', carController.list);
app.post('/api/shotgun',shotgunController.callIt)
app.post('/api/dispute', disputeController.dispute);
